...
namespace Conflux.Tests
{
    public class FacebookRequestHandlerMock : IFacebookRequestHandler
    {
        ...
        public Task<string> GetEventsByKeywordAsync(string locationKeyword, uint offset = 0, uint? limit = null, DateTime? since = null, DateTime? until = null)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<string> GetHighlightsEvents(DateTime? since, DateTime? until)
        {
            throw new NotImplementedException();
        }
